#!/usr/bin/python3
"""Unittest module for the BaseModel parent Class"""
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_3_init_many_args(self):
        """Tests the__init__ with many arguments."""
        self.resetStorage()
    ...
    def test_5_save_no_args(self):
        """Tests the save() with no arguments."""
        self.resetStorage()
        with self.assertRaises(TypeError) as e:
            BaseModel.save()
    ...
    def test_5_save_excess_args(self):
        """Tests the save() with too many arguments."""
        self.resetStorage()
        with self.assertRaises(TypeError) as e:
